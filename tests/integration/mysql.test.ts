/**
 * MySQL System Integration Tests
 *
 * Tests the full container lifecycle with real MySQL processes.
 */
...
describe('MySQL Integration Tests', () => {
  ...
  it('should start the container', async () => {
    ...
    assert(ready, 'MySQL should be ready to accept connections')
  ...
  it('should create a new container from connection string (dump/restore)', async () => {
    ...
    assert(ready, 'Cloned MySQL should be ready')
