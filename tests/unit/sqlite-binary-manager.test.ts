...
describe('SQLite binary-urls', () => {
  ...
  describe('getBinaryUrl', () => {
    ...
    it('should generate valid URL for darwin-x64', () => {
      const url = getBinaryUrl('3', 'darwin', 'x64')
    ...
    it('should generate valid URL for linux-x64', () => {
      const url = getBinaryUrl('3', 'linux', 'x64')
...
describe('SQLiteBinaryManager', () => {
  ...
  describe('getDownloadUrl', () => {
    it('should generate valid hostdb URL', () => {
      const url = sqliteBinaryManager.getDownloadUrl('3', 'darwin', 'arm64')
    ...
    it('should use correct file extension for platform', () => {
      const unixUrl = sqliteBinaryManager.getDownloadUrl('3', 'darwin', 'arm64')
      const winUrl = sqliteBinaryManager.getDownloadUrl('3', 'win32', 'x64')
  ...
  describe('verify', () => {
    it('should throw error for non-existent binary', async () => {
      try {
        await sqliteBinaryManager.verify('99', 'darwin', 'arm64')
        assert(false, 'Should have thrown an error')
      } catch (error) {
        assert(error instanceof Error, 'Should throw Error')
        assert(
