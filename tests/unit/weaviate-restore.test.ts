/**
 * Weaviate restore module unit tests
 */
...
describe('Weaviate Restore Module', () => {
  ...
  describe('detectBackupFormat', () => {
    ...
    it('should detect .json backup metadata', async () => {
      await mkdir(testDir, { recursive: true })
      ...
      assertEqual(format.format, 'snapshot', 'Should detect JSON as snapshot')
  ...
  describe('parseConnectionString', () => {
    it('should parse http connection string', () => {
      ...
      assertEqual(result.port, 8080, 'Port should be 8080')
    ...
    it('should parse https connection string', () => {
      ...
      assertEqual(result.host, 'weaviate.example.com', 'Host should be correct')
      assertEqual(result.port, 8080, 'Port should be 8080')
    ...
    it('should use default port for http', () => {
      ...
      assertEqual(result.port, 8080, 'Default HTTP port should be 8080')
    })
