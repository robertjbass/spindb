#!/usr/bin/env tsx
/**
 * Generate a PostgreSQL database with sample data.
 *
 * Usage:
 *   pnpm generate:db postgresql [container-name] [--port <port>]
 */
...
async function main(): Promise<void> {
  ...
  console.log('PostgreSQL Database Generator')
  console.log('=============================\n')
  ...
  if (!isReady) {
    console.error('Error: PostgreSQL did not become ready in time')
    process.exit(1)
  }
