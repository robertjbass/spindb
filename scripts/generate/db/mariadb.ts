#!/usr/bin/env tsx
/**
 * Generate a MariaDB database with sample data.
 *
 * Usage:
 *   pnpm generate:db mariadb [container-name] [--port <port>]
 */
...
async function main(): Promise<void> {
  ...
  console.log('MariaDB Database Generator')
  console.log('==========================\n')
  ...
  if (!isReady) {
    console.error('Error: MariaDB did not become ready in time')
    process.exit(1)
  }
