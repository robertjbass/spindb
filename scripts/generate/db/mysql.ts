#!/usr/bin/env tsx
/**
 * Generate a MySQL database with sample data.
 *
 * Usage:
 *   pnpm generate:db mysql [container-name] [--port <port>]
 */
...
async function main(): Promise<void> {
  ...
  console.log('MySQL Database Generator')
  console.log('========================\n')
  ...
  if (!isReady) {
    console.error('Error: MySQL did not become ready in time')
    process.exit(1)
  }
